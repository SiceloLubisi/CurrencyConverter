...
namespace CurrencyConverter
{
    public partial class frmCurrencyConverter : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (cmbFrom.SelectedItem == "South African Rand" && cmbTo.SelectedItem == "United States Dollar")
            {
                //int i = int.Parse(txtAmount.Text);
            ...
            else if (cmbFrom.SelectedItem == "United States Dollar" && cmbTo.SelectedItem == "South African Rand")
            {
            ...
            else if (cmbFrom.SelectedItem == "Euro" && cmbTo.SelectedItem == "South African Rand")
            {
            ...
            else if (cmbFrom.SelectedItem == "South African Rand" && cmbTo.SelectedItem == "Euro")
            {
                double con = (double)(i * 0.058);
                double dcon = Math.Round(con, 2);
                lblConvertedAmount.Text = "Convertet Amount: R" + dcon;
